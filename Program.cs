...
namespace dotnet_webapi_demo_01_christenzarif
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var connectionString = $"Server=db6050.public.databaseasp.net;Database=db6050.databaseasp.net;Persist Security Info=False;User ID=db6050;Password=4Wc%K!7y#6oM;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;Connection Timeout=30;";
